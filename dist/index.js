(function () {
	...
	let Tpl_projectInfo = class extends RP {
						constructor(model, logic) {
							const tree = {"vDom":{"tree":[{"type":"tag","tagName":"div","attrs":{"class":{"value":"menu","type":"string"}},"childNodes":[{"type":"tag","tagName":"item","attrs":{"name":{"value":"build","type":"string"}},"childNodes":[{"type":"tag","tagName":"i","attrs":{"class":{"value":"ico hammer actionHover","type":"string"}},"childNodes":[]},{"type":"tag","tagName":"span","attrs":{"class":{"value":"actionHover","type":"string"},"onclick":{"type":"event","fn":"self.build();"}},"childNodes":[{"type":"textNode","value":"Build"}]}]}]},{"type":"tag","tagName":"div","attrs":{"name":{"value":"projectInfo","type":"string"}},"childNodes":[]}]}};
							super(tree, model, logic);
						}
					};
					customElements.define('x-tpl_projectinfo', Tpl_projectInfo);
				
					let Tpl_projectInfo_item = class extends RP {
						constructor(model, logic) {
							const tree = {"vDom":{"tree":[{"type":"tag","tagName":"div","attrs":{"class":{"value":"control","type":"string"}},"childNodes":[{"type":"tag","tagName":"span","attrs":{"name":{"value":"projectName","type":"string"}},"childNodes":[{"type":"splitNode"},{"type":"textNode","value":"","placeNum":1,"valueInRender":null,"valueOutRender":"name","modelDepends":[]},{"type":"splitNode"}]}]},{"type":"tag","tagName":"ul","attrs":{"name":{"value":"tree","type":"string"}},"childNodes":[]}]}};
							super(tree, model, logic);
						}
					};
					customElements.define('x-tpl_projectinfo_item', Tpl_projectInfo_item);
	...
	let Tpl_head = class extends RP {
						constructor(model, logic) {
							const tree = {"vDom":{"tree":[{"type":"tag","tagName":"span","attrs":{"onmousedown":{"type":"event","fn":"self.select(event);"}},"childNodes":[{"type":"splitNode"},{"type":"textNode","value":"","placeNum":2,"valueInRender":null,"valueOutRender":"m.name","modelDepends":[{"refName":"m","modelPath":"name","canSync":true}]},{"type":"splitNode"}]}]}};
							super(tree, model, logic);
						}
					};
